...
const ProductCard = ({ product, index }) => {
  return (
    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4 shadow-sm">
      <div className="aspect-4/3 overflow-hidden rounded-[1.25rem] border border-zinc-300 bg-zinc-200">
        <img
          src={product.image}
