...
function SignUpPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setFormMessage(error.message || 'Unable to create the account.')
      return
    }
  }
  ...
  return (
    <Stack component="form" spacing={2.5} onSubmit={handleSubmit} noValidate>
      <Typography color="text.secondary">
        Create an editor account to manage articles and review dashboard
        activity. Administrator access is assigned separately.
      </Typography>
